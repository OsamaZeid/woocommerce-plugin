...
jQuery(document).ready(function ($) {
  ...
  $("#woocommerce_tz_tazapay_sandboxmode").change(function () {
    if (this.value == "sandbox") {
      ...
      $(".signup-help-text").text("Request Sandbox credentials for accepting payments via Tazapay. Signup now and go to 'Request API Key'");
    ...
    if (this.value == "production") {
      ...
      $(".signup-help-text").text("Request Production credentials for accepting payments via Tazapay. Signup now and go to 'Request API Key'");
